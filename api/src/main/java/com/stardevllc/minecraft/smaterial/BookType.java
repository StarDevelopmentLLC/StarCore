package com.stardevllc.minecraft.smaterial;
...
public enum BookType {
    ...
    static {
        ...
        try {
            ...
            Object converter = enumConstructor.newInstance(BookType.class);
            Method addConverterMethod = stringConvertersClass.getDeclaredMethod("addConverter", Class.class, stringConverterClass);
            addConverterMethod.invoke(null, BookType.class, converter);
        } catch (Exception e) {}
    }
}
